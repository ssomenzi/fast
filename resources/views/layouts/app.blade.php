            ...
            <div class="container mx-auto h-full">
                <div class="flex items-center justify-center h-12">
                    <div class="mr-6">
                        ...
                        <a class="no-underline hover:underline text-teal-darker px-3 text-sm" href="{{ url('/home') }}">{{ __('Dashboard') }}</a>
                        <a class="no-underline hover:underline text-teal-darker pr-3 text-sm" href="{{ url('/about') }}">{{ __('About') }}</a>
                    </div>
